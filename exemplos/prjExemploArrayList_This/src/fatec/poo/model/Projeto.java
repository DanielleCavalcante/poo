...
public class Projeto {
    ...
    private ArrayList<Funcionario> funcionarios;  //multiplicidade 1..*
            //tipo de agrupamento (objetos da classe Funcionario)
    ...
    public void addFuncionario(Funcionario f){ 
        funcionarios.add(f); //inserção sempre no final da lista
        f.setProjeto(this);
    }
    public void listarFuncionarios(){
        ...
        for(int x =0; x < funcionarios.size() ;x++){
            System.out.print(funcionarios.get(x).getRegistro()); //acessar o objeto da posicao x, para conseguir interagir com ele
